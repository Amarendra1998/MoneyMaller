...
public class Home extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            Intent intent = new Intent(Home.this,CreditScore.class);
            startActivity(intent);
        } else if (id == R.id.nav_detail) {
            Intent intent = new Intent(Home.this,EmploymentDetail.class);
            startActivity(intent);
        } else if (id == R.id.nav_document) {
            Intent intent = new Intent(Home.this,Document.class);
            startActivity(intent);
        } else if (id == R.id.nav_application_tracking) {
            Intent intent = new Intent(Home.this,Tracking.class);
            startActivity(intent);
        } else if (id == R.id.nav_consent) {
            Intent intent = new Intent(Home.this,Consent.class);
            startActivity(intent);
